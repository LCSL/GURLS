...
elseif(BLAS_LAPACK_IMPLEMENTATION STREQUAL "VECLIB")

    find_package(VECLIB)

    #set(BLAS_LAPACK_INCLUDE_DIRS ${VECLIB_INCLUDE_DIRS})
    #set(BLAS_LAPACK_LIBRARY_DIRS ${VECLIB_LIBRARY_DIRS})
    #set(BLAS_LAPACK_DEFINITIONS ${VECLIB_DEFINITIONS})
    set(BLAS_LAPACK_LIBRARIES ${VECLIB_LIBRARIES})
    set(BLAS_LAPACK_FOUND ${VECLIB_FOUND})
