...
*/
		...
		*/
	{
		...
		if (arg.require(nrhs,prhs,"balanced_ridge"))
			arg.getscalar(nrhs,prhs,"balanced_ridge",&balanced_ridge);

		if (arg.require(nrhs,prhs,"coef0"))
			arg.getscalar(nrhs,prhs,"coef0",&coef0);

		if (arg.require(nrhs,prhs,"nu"))
			arg.getscalar(nrhs,prhs,"nu",&nu);

		if (arg.require(nrhs,prhs,"cachesize"))
			arg.getscalar(nrhs,prhs,"cachesize",&cachesize);

		if (arg.require(nrhs,prhs,"degree"))
			arg.getscalar(nrhs,prhs,"degree",&degree);

		if (arg.require(nrhs,prhs,"gamma"))
			arg.getscalar(nrhs,prhs,"gamma",&gamma);

		if (arg.require(nrhs,prhs,"svm_type"))
