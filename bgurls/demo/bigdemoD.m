% THIS DEMO DOES NOT USE A DISTRIBUTED FILESYSTEM TO SPEED UP THE COMPUTATION OF
...
opt.seq = {'paramsel:hoprimal','rls:primal','pred:primal','perf:macroavg'};
...
% Now you should have a mat file in "wpath" named 'bio_demoD.mat'.
